...
def initialkickoff():
    ...
    # Subtract 7 days
    one_year_ago = datetime.utcfromtimestamp(current_time_ms / 1000) - timedelta(days=365)
    ...
    historical_data = fetch_historical_klines("SOLUSDT", "1", one_year_ago)
    ...
    df.to_sql("oneminsolusdt", con=engine, if_exists="replace", index=False)  # Use 'append' to add data without replacing
